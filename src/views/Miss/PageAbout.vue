...
<template>
  <div class="root-page-about">
    ...
    <section class="section-text">
      ...
      <p>Подготовка к&nbsp;конкурсу длится почти <mark>2&nbsp;месяца</mark>, и&nbsp;состоит из&nbsp;репетиций творческих номеров, постановок дефиле, съемок, интервью и&nbsp;фотосессий. Такой плотный график и&nbsp;подготовка позволяют каждой участнице конкурса <mark>раскрыться на&nbsp;максимум</mark> во&nbsp;время финала.</p>
...
<!--    </section>-->
    ...
    <section class="section-text">
      ...
      <ViewPortWatcher on-ref="nomination-4" v-model="nominationsVisible[4]" :bottom-offset="100" :top-offset="-200"><div ref="nomination-4" class="nomination-container" :class="{'hidden': !nominationsVisible[4]}">
        ...
        <p>Мисс Дружба — единственная номинация, победительницу в&nbsp;которой выбирают сами участницы конкурса путем тайного голосования, проходящего за&nbsp;день до&nbsp;финального мероприятия. На&nbsp;протяжении всей подготовки к&nbsp;финалу девушки становятся настоящими подругами, а&nbsp;титул «Мисс Дружба» получает та&nbsp;девушка, которая стала душой прекрасного коллектива.</p>
      </div></ViewPortWatcher>
